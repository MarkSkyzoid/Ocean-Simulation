...
{                                                                                               
 ...
 void main()
 {
		...
		varying_foam_te = gl_TessCoord.x * varying_foam_tc[0] + gl_TessCoord.y * varying_foam_tc[1] + gl_TessCoord.z * varying_foam_tc[2];
